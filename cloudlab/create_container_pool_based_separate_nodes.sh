...
SERVERS_SSD="node-1"
SERVERS_HDD="node-2 node-3"
SERVERS=`echo ${SERVERS_SSD}" " ${SERVERS_HDD}`
...
OSD_NUM_IN_CACHE_POOL=`echo $SERVERS_SSD | wc -w`
PG_NUM_CACHE_POOL=`expr $OSD_NUM_IN_CACHE_POOL \* 100`
PG_NUM_CACHE_POOL=`power2 $PG_NUM_CACHE_POOL`

OSD_NUM_IN_STORAGE_POOL=`echo $SERVERS_HDD | wc -w`
PG_NUM_STORAGE_POOL=`expr $OSD_NUM_IN_STORAGE_POOL \* 100`
PG_NUM_STORAGE_POOL=`power2 $PG_NUM_STORAGE_POOL`

CONFIG_OPTS="-e POOL_SIZE=1 -e PG_NUM_CACHE_POOL=$PG_NUM_CACHE_POOL -e PG_NUM_STORAGE_POOL=$PG_NUM_STORAGE_POOL -e OP_THREADS=32 -e BS_CACHE_SIZE=0"
